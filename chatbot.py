...
info_cache = {
    "test_session": {
        "position": "인공지능 연구 엔지니어",
        "interest": "딥러닝, 자연어 처리",
        "history": "스타트업에서 머신러닝 엔지니어로 2년 근무",
        "language": "Python, JavaScript",
        "project": "고객 응대를 위한 NLP 기반 챗봇 개발",
        "resume": "컴퓨터공학 학사, Google ML 부트캠프 수료"
    }
}


gen_q_response(info_cache, 0, role = "엄격한")